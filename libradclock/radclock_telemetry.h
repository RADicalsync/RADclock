...
#define RADCLOCK_TELEMETRY_VERSION 4

typedef struct Radclock_Telemetry_v4 Radclock_Telemetry_Latest;
typedef struct Radclock_Telemetry_ICN_v4 Radclock_Telemetry_ICN_Latest;
...
struct Radclock_Telemetry_ICN_v4
{
   unsigned int status_word;
   int ICN_id;
   double uA;
